...
>
// Optimized svg
    <path fill="currentColor" d="M13.653 1.008A1.5 1.5 0 0 1 15 2.5v10l-.008.153a1.5 1.5 0 0 1-1.339 1.34L13.5 14h-12l-.153-.008a1.5 1.5 0 0 1-1.34-1.339L0 12.5v-10a1.5 1.5 0 0 1 1.347-1.492L1.5 1h12zM8 13h5.5a.5.5 0 0 0 .5-.5V8H8zm-7-.5a.5.5 0 0 0 .5.5H7V8H1zM8 7h6V2.5a.5.5 0 0 0-.5-.5H8zM1.5 2a.5.5 0 0 0-.5.5V7h6V2z"/>
</svg>
