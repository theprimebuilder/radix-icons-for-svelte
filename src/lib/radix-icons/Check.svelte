...
>
// Optimized svg
    <path fill="currentColor" d="M10.602 3.908a.626.626 0 0 1 1.046.684l-4.25 6.5a.626.626 0 0 1-.944.12l-2.75-2.5-.084-.094a.626.626 0 0 1 .823-.906l.103.075 2.207 2.006z"/>
</svg>
