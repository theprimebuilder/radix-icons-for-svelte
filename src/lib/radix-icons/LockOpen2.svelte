...
>
// Optimized svg
    <path fill="currentColor" d="M11.501 0c1.173 0 2.138.39 2.762 1.193l.09.123c.439.628.647 1.426.647 2.317h-1c0-.691-.15-1.245-.41-1.658l-.117-.168C13.084 1.306 12.448 1 11.5 1c-.858 0-1.464.265-1.86.687C9.243 2.112 9 2.76 9 3.636V6h1a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h7V3.636c0-1.055.293-1.975.912-2.634C9.535.338 10.43 0 11.501 0M1 13h9V7H1z"/>
</svg>
